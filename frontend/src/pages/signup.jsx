...
export default function SignUp() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Handle registration pipeline logic here
    ...
    return (
        <div className="bg-white text-zinc-950 min-h-screen flex flex-col w-screen max-w-full overflow-x-hidden">
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 w-full max-w-[1440px] mx-auto">
                ...
                {/* Left Column: Visual Backdrop (Hidden on mobile) */}
                <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden bg-zinc-950 text-white">
                    ...
                    <div className="relative z-10 max-w-[460px] flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-400 text-xs">Emporing 5,000+ Future Developers</p>
                        </div>
                    </div>
                </div>

                {/* Right Column: Registration Form Structure */}
                    ...
                    <Card className="w-full max-w-[460px] shadow-xl rounded-2xl bg-white border-zinc-200/80 p-2 md:p-4">
                        ...
                        <CardContent>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                {/* Dynamic Contextual Field depending on selected role */}
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            type="text"
                                            placeholder={role === "student" ? "Stanford University" : "Stark Industries"}
                                ...
                                <Button
                                    type="submit"
                                    className="w-full shadow-md font-semibold rounded-xl bg-[#f0b100] text-white h-11 transition-all hover:bg-[#d69e00] cursor-pointer mt-4"
                                >
